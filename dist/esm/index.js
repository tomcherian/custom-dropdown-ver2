...
var css_248z = ".dropdown-wpr {\r\n  position: absolute;\r\n  /* top: 45px; */\r\n  display: flex;\r\n  flex-direction: column;\r\n  width: 47%;\r\n  max-height: 10rem;\r\n  overflow-y: scroll;\r\n  overflow-x: hidden;\r\n}\r\n\r\n.dropdown-items {\r\n  padding: 2px 0 2px 10px;\r\n  border-radius: 5px;\r\n  height: 1.5rem;\r\n  display: flex;\r\n  align-items: center;\r\n  cursor: pointer;\r\n  background-color: hsla(0, 0%, 100%, 0.64);\r\n}\r\n\r\n.dropdown-items:hover {\r\n  background: linear-gradient(106.23deg, #226fae, #226fae 100%);\r\n  color: #fff;\r\n}\r\n";
styleInject(css_248z);

var Dropdown = function (_a) {
    var options = _a.options, onSelectDropdown = _a.onSelectDropdown;
    return (React.createElement("div", { className: "dropdown-wpr" }, options.length ? (options.map(function (option, id) { return (React.createElement("div", { className: "dropdown-items", key: id, onClick: function () {
            onSelectDropdown(option.name.common);
        } }, option.name.common)); })) : (React.createElement("div", { className: "dropdown-items" }, "No Options got it"))));
};
